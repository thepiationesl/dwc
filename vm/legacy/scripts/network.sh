...
initNetworkConfig() {
    ...
    VM_NET_TAP="${VM_NET_TAP:-$(getConfig VM_NET_TAP)}"
    VM_NET_DEV="${VM_NET_DEV:-$(getConfig VM_NET_DEV)}"
    VM_NET_IP="${VM_NET_IP:-$(getConfig VM_NET_IP)}"
    VM_NET_MASK="${VM_NET_MASK:-$(getConfig VM_NET_MASK)}"
    VM_NET_DHCP_START="${VM_NET_DHCP_START:-$(getConfig VM_NET_DHCP_START)}"
    VM_NET_DHCP_END="${VM_NET_DHCP_END:-$(getConfig VM_NET_DHCP_END)}"
